...
public class ProblemController {
    ...
    List<Problem> findAll() {
        return problemService.findAll(Problem.class);
    }

    @GetMapping("/{id}")
    public Problem findById(@PathVariable Integer id) throws NotFoundException {
        return problemService.findById(id, Problem.class);
    }
